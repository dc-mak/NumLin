...
let kalman sigma h mu r_1 data_1 =
  ...
  let h_sigma = Prim.matrix k n in
  let (sigma, h), h_sigma =
    Prim.symm (Many true) (Many 1.) sigma h (Many 0.) h_sigma
  in
  let (h_sigma, h), r_2 =
    Prim.gemm (Many 1.) (h_sigma, Many false) (h, Many true) (Many 1.) r_1
  in
  let (h, mu), data_2 =
    Prim.gemm (Many 1.) (h, Many false) (mu, Many false) (Many (-1.)) data_1
  in
  let h, new_h = Prim.copy_mat_to h h_sigma in
