...
\prechapter{%
    ...
    linear types to keep this thesis accessible to working programmers as well
    as academics not familiar with type-theory and will give only a terse
    overview of the history and theory behind linear types for the interested
