...
(Here, $\theta$ is the empty substitution for $\varsigma = \den{H}{}{\sigma}\theta$.)
...
\subsection{$\forall e, \sigma, e', \sigma', \theta.\
    ...
    \Rightarrow \langle \theta(e), \theta(\sigma)
    \rangle \rightarrow \langle \theta(e') , \theta(\sigma') \rangle$}\label{fracPermSub}
...
\begin{proof}
    ...
    \step{}{\case{\textsc{Op\_Frac\_Perm.}}{Because substitution avoids capture,
        \\ $\langle \theta((\ottkw{fun} fc \rightarrow v) \, [f]),
        \theta(\sigma) \rangle \rightarrow \langle \theta(v\, [fc/f]),
        \theta(\sigma'\, [fc/f]) \rangle$.}}
    ...
    \step{}{\textsc{Corollary:}
        If $\langle e\, [fc/f_1], \sigma \, [fc/f_1] \rangle \rightarrow^n
        \langle v_2, \sigma_2 \rangle$ and
        $\langle e\, [fc/f_2], \sigma \, [fc/f_2] \rangle \rightarrow^n
        \langle v_2, \sigma_2 \rangle$, then
        $\exists\,v, \sigma.\ v_1 = v\,[fc/f_1] \wedge v_2 = v\,[fc/f_2]
        \sigma_1 = \sigma\,[fc/f_1] \wedge \sigma_2 = \sigma\,[fc/f_2]$.}
