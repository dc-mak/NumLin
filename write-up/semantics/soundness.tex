...
\begin{proof}
    ...
    \begin{proof}
        ...
        \step{}{By \ref{disjoint}, we have $\theta(\delta(\gamma(e'))) [v/x] =
    ...
    \begin{proof}
        ...
        \step{}{\suffices{$(\varsigma_{e'}, \theta(\delta(\gamma(e'))) [v / x])
        ...
        \step{}{By \ref{disjoint}, $(\varsigma_{e'}, \theta(\delta(\gamma(e'))) [v / x]) \in
            \C{k-i-1}{\theta(t)}$.}
    ...
    \begin{proof}
        ...
        \step{}{\assume{Arbitrary $f'$.} \suffices{$(\varsigma', e' [f' / f\!c] )
