...
constructs to OCaml constructs, with the appropriate sprinkling of \ltfla{Many}
...
Even though Figure~\ref{fig:ocaml_kalman} is in OCaml, I see little reason that
