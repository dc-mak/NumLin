...
\begin{proof}
    ...
    \assume{arbitrary $j \leq k + 1$, and $\sigma_r$ such that $\varsigma
    ...
    \step{}{\case{$j \geq 1$. We have $\langle \sigma, e \rangle
        ...
        Instantiate $(\varsigma', e') \in \C{k}{t}$, with $j-1 \leq k$ and
...
Need to prove for $\V{}{}$, by induction on \ref{stepInC} for $\C{}{}$.
