...
\begin{proof}
    ...
    \begin{proof}
        ...
        \step{}{By induction, $\forall k.\ \den{}{k}{\Theta, f\!c; \Delta; \Gamma
            \vdash e : t}$.}

        \step{}{\pflet{ $f$ be arbitrary; $\theta' \equiv \theta[f\!c \mapsto f]$.}
        ...
        \step{}{So, \textsc{Op\_Context} runs $i_e$ times, and then we have the
            ...
            f\!c \rightarrow e' ) \in \V{k-i_e}{\theta(\forall f\!c.\ t)}$ (for $f=f\!c$).}}

        \step{}{\assume{Arbitrary $f'$.} \suffices{$(\varsigma', e' [f\!c / f'] )
            \in \V{k-1-i_e}{\theta(t)[f\!c/f']}$ (for $f=f\!c$).}}

        \step{}{This is true by instantiating \pfref{valueAllF} with $f=f'$.}
    ...
    \begin{proof}
        ...
        \step{}{By induction, $\forall k.\ \den{}{k}{\Theta; \Delta; \Gamma
            \vdash e : \forall f\!c.\ t }$.}

        \step{}{Instantiate with $k, \theta, \delta, \gamma, \sigma$ to conclude
            $(\varsigma, \theta(\delta(\gamma(e)))) \in \C{k}{\theta(\forall f\!c.\ t})$.}
        ...
        \step{}{If it is, then $\exists i_e \leq j.\  (\varsigma_f, e_f) \in
            \V{k-i_e}{\theta(\forall f\!c. t)} \subseteq \V{k-j}{\ldots}$ by
            \ref{valueSub} and \ref{subsetKJ}.\\
        ...
        \step{}{So, \textsc{Op\_Context} runs $i_e$ times, and then we have the following.
            ...
            (\ottkw{fun} f\!c \rightarrow v)\, [f] ) \in \C{k-i_e}{\theta(t[f\!c/f])}$.}
            \suffices{By \ref{stepInC} once more, $(\varsigma_f, v [f\!c / f]) \in
            \C{k-i_e-1}{\theta(t[f\!c/f])}$.}}
