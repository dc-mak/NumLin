...
\begin{proof}
    ...
    \assume{%
        \begin{pfenum}
            ...
            \item ??? $j \leq k \Rightarrow \den{\_\ }{k}{\cdot} \subseteq \den{\_\ }{j}{\cdot}$\label{subsetKJ}
    ...
    \begin{proof}
        ...
        \step{}{\case{$\ottkw{err}$}{??? By \textsc{Op\_Context\_Err}, \ref{disjoint}, so too
            does the whole expression. Since $j \leq k$ and $\sigma_{r}$ (for \ref{frame}) are
            arbitrary, $({\sigma_1}_f \star \sigma_{e_2}, \, (v_1, e_2)\, ) \in \C{k-j}{\theta(t_1
            \otimes t_2)}$.}}
