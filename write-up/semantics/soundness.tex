...
\begin{proof}
    ...
    \begin{proof}
        ...
        \step{}{\pflet{ $f$ be arbitrary; $\theta' \equiv \theta[fc \mapsto f]$.}
            ...
            \\ to conclude $(\varsigma, \theta'(\gamma(\delta(e)))) \in \C{k}{\theta'(t)}$
            (for all $f$).}
        ...
        \step{}{\case{$j$ steps to $\ottkw{err}$.}{By
            ...
            $\ottkw{err}$ in $j < k$ steps (for $f=fc$).}}
        ...
        \step{}{If it is, then $\exists i_e \leq j.\  (\varsigma', e') \in
            \V{k-i_e}{\theta'(t)} \subseteq \V{k-j}{\ldots}$ by \ref{valueSub} and
        ...
        \step{}{\assume{Arbitrary $f'$.}
            \suffices{$(\varsigma', e' [fc / f'] ) \in \V{k}{\theta(t)[fc/f']}$ (for $f=fc$).}}

        \step{}{This is true by \pfref{valueAllF} for $f=f'$.}
    ...
    \begin{proof}
        ...
        \step{}{Instantiate with $k, \theta, \delta, \gamma, \sigma$ to conclude
            $(\varsigma, \theta(\gamma(\delta(e)))) \in \C{k}{\forall fc.\ t}$.}
        ...
        \step{}{If it is, then $\exists i_e \leq j.\  (\varsigma_f, e_f) \in
            \V{k-i_e}{\forall fc. t} \subseteq \V{k-j}{\ldots}$ by
            \ref{valueSub} and \ref{subsetKJ}.\\
            So, \textsc{Op\_Context} runs $i_e$ times, and then we have the following.
            \suffices{By \ref{stepInC} $i_e$ times, $(\varsigma_f, e_f\, [f] )
                \in \C{k-i_e}{t[fc/f]}$.}}
        
        \step{}{Instantiate $(\varsigma_f, e_f) \in \V{k-i_e}{\forall fc. t}$
            with $f$ to conclude precisely that.}
