...
\begin{proof}
    ...
    \step{}{%
        \case{%
            ...
            \suffices{By \ref{subsetVC} to show $(\sigma,
                \theta(\gamma(\delta(\ottkw{fun}\, fc \rightarrow e)))) \in
                \V{k}{\theta(\forall \, fc.\, t)}$.}

            \assume{Assume arbitrary fraction $f$.}

            \suffices{$(\varsigma, \theta(\gamma(\delta(e [fc/f] )))) \in
                \C{k}{\theta(t) [fc/f]}.$ }
        }
    }
    ...
    \begin{proof}
        ...
        \step{}{So using $k, \theta[fc \mapsto f], \delta, \gamma, \sigma$ we conclude
            $(\varsigma, \theta[fc \mapsto f](\gamma(\delta(e)))) \in \C{k}{\theta[fc \mapsto f](t)}$.}
