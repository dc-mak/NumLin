...
\begin{proof}
    ...
    \begin{proof}
        ...
        \step{}{Instantiate \emph{this} with $j - i_e$ and $\sigma_f$ to conclude
            ...
            steps to $\ottkw{err}$ or $\langle \sigma_f + \sigma_f', e_f' \rangle$.}
    ...
    \begin{proof}
        ...
        \step{}{This is true by definition of $\V{-}{\forall fc.\ t}$ and
            \pfref{valueAllF} for $f=f'$.}
    ...
    \begin{proof}
        ...
        \step{}{Instantiate with $k, \theta, \delta, \gamma, \sigma$ to conclude
            $(\varsigma, \theta(\gamma(\delta(e)))) \in \C{k}{\theta(\forall fc.\ t})$.}
